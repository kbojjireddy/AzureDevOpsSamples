...
$output = 'Setting the MinimumTlsVersion to : {0} on the Storage Account : {1} located in the Resource Group : {2} {3}' -f $MinimumTlsVersion,$saName,$saResourceGroupName, $saResourceGroupId 
